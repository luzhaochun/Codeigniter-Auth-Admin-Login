                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav in" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('Index');?>" class="active"><i class="fa fa-dashboard fa-fw"></i> 首页</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 权限管理<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                                    <li>
                                        <a href="<?php echo site_url('Authgroup/index');?>">角色列表</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo site_url('Authgroup/menuList');?>">菜单列表</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            <li>
                                <a href="<?php echo site_url('Admin/index');?>"><i class="fa fa-table fa-fw"></i> 管理员管理</a>
                            </li>
                            <li>
                                <a href="forms.html"><i class="fa fa-edit fa-fw"></i> 企业管理</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-wrench fa-fw"></i> 统计管理<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                                    <li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-sitemap fa-fw"></i> 系统配置<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                                    <li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-files-o fa-fw"></i> 商城管理<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                                    <li>
